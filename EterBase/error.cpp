...
int SetEterExceptionHandler()
{
	...
	info.pszAppName = _T("Metin2Client"); // Define application name.
	info.pszAppVersion = _T("1.0.2"); // Define application version.
	// URL for sending error reports over HTTP.
	info.pszUrl = _T("https://sumnix.org/crashrpt.php");                    
	// Install all available exception handlers.
	info.pszEmailSubject = _T("DEV_CLIENT Error Report");  
	info.pszEmailTo = _T("arkhan2@sumnix.org");    
