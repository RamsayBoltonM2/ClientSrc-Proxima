...
//		} TItemTable;
		...
		typedef struct SItemScaleTable {
			D3DXVECTOR3 scalePos[2][4];
			D3DXVECTOR3 scale[2][4];
...
#ifdef WJ_ACCE_SYSTEM
		void SetItemTableScaleData(int dwJob, int dwSex, float fScaleX, float fScaleY, float fScaleZ, float fScalePosX, float fScalePosY, float fScalePosZ);
