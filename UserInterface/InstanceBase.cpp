...
UINT CInstanceBase::SHORSE::GetLevel()
{
	if (m_pkActor)
	{
		...
		switch (mount)
		{
			...
			case 20102:
			case 20103:
			case 20233:	// Yavru_Hindi
				return 1;
			case 20104:
			case 20105:
			case 20106:
			case 20234:	// Vahsi_Hindi
				return 2;
			case 20107:
			case 20108:
			case 20109:
...
bool CInstanceBase::Create(const SCreateData& c_rkCreateData)
{
	...
	if(c_rkCreateData.m_dwRace == 34041 || c_rkCreateData.m_dwRace == 34045 || c_rkCreateData.m_dwRace == 34049 || c_rkCreateData.m_dwRace == 34053 || c_rkCreateData.m_dwRace == 34064)
	{
...
#if defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
		SetWeapon(c_rkCreateData.m_dwWeapon, c_rkCreateData.m_lWeaponRarity, c_rkCreateData.m_dwArrowType);
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
	...
	{
#ifdef WJ_GROWTH_PET_SYSTEM
		if (m_dwRace >= 34041 && m_dwRace <= 34066)
		{
...
#endif
		{
			...
			{
				m_GraphicThingInstance.SetScaleNew(fx, fy, fz);
			}
		}
	}
...
#ifdef ENABLE_ATTACH_SPECULAR_FROM_LIST
	struct SAttachSpecularData
	{
		DWORD race; float specularPower;
	};

	const int SPECULAR_MAX_NUM = 50;
	static SAttachSpecularData structInfo[SPECULAR_MAX_NUM] =
	{
		{ 20115,     0.2f },	{ 20209,     0.2f },	{ 20230,     0.2f },
		{ 20116,     0.2f },	{ 20210,     0.2f },	{ 20231,     0.2f },
		{ 20117,     0.2f },	{ 20211,     0.2f },	{ 20232,     0.2f },
		{ 20118,     0.2f },	{ 20212,     0.2f },	{ 20233,     0.2f },
		{ 20119,     0.2f },	{ 20213,     0.2f },	{ 20234,     0.2f },
		{ 20120,     0.2f },	{ 20214,     0.2f },	{ 20235,     0.2f },
		{ 20121,     0.2f },	{ 20215,     0.2f },	{ 20236,     0.2f },
		{ 20122,     0.2f },	{ 20216,     0.2f },	{ 20238,     0.2f },
		{ 20123,     0.2f },	{ 20217,     0.2f },	{ 20239,     0.2f },
		{ 20124,     0.2f },	{ 20218,     0.2f },	{ 20210,     0.2f },
		{ 20125,     0.2f },	{ 20219,     0.2f },
		{ 20201,     0.2f },	{ 20220,     0.2f },
		{ 20202,     0.2f },	{ 20223,     0.2f },
		{ 20203,     0.2f },	{ 20224,     0.2f },
		{ 20204,     0.2f },	{ 20225,     0.2f },
		{ 20205,     0.2f },	{ 20226,     0.2f },
		{ 20206,     0.2f },	{ 20227,     0.2f },
		{ 20207,     0.2f },	{ 20228,     0.2f },
		{ 20208,     0.2f },	{ 20229,     0.2f },
	};
...
#ifdef WJ_WOLFMAN_CHARACTER
			if (12010 <= vnum && vnum <= 12049 || vnum <= 21080 && vnum <= 21089)
#else
			if (12010 <= vnum && vnum <= 12049)
#endif
			{
...
#if defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
bool CInstanceBase::SetWeapon(DWORD eWeapon, long lWeaponRarity, DWORD eArrow)
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
...
#if defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
void CInstanceBase::ChangeWeapon(DWORD eWeapon, long lWeaponRarity, DWORD eArrow)
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
...
#if defined(WJ_WEAPON_COSTUME_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
...
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
	if (SetWeapon(eWeapon, lWeaponRarity))
#elif !defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
...
bool CInstanceBase::SetAcce(DWORD eAcce)
{
	...
	if (eAcce)
	{
		...
		if (CItemManager::Instance().GetItemDataPointer (eAcce, &pItemData))
		{
			...
			TPixelPosition pos = pItemData->GetItemScalePosition (Job, Sex);
...
bool CInstanceBase::ChangeArmor(DWORD dwArmor)
{
	...
	SetHair(eHair);
#ifdef WJ_EVOLUTION_SYSTEM
	SetWeapon(eWeapon, m_lWeaponRarity);
#else
	SetWeapon(eWeapon);
#endif
#ifdef WJ_ACCE_SYSTEM
