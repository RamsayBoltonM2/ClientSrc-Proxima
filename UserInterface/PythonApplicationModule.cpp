...
#ifdef WJ_PLAYER_TITLE_NAME_SYSTEM
...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "WJ_ACCE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_ACCE_SYSTEM", 0);
#endif

#ifdef WJ_SOULBINDING_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_SOULBINDING_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SOULBINDING_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "WJ_INVENTORY_EX_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_INVENTORY_EX_SYSTEM", 0);
#endif

#ifdef WJ_MOUNT_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_MOUNT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_MOUNT_SYSTEM", 0);
#endif

#ifdef WJ_EVOLUTION_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_EVOLUTION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_EVOLUTION_SYSTEM", 0);
#endif

#ifdef WJ_DRAGON_HUNTERS_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_DRAGON_HUNTERS_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_DRAGON_HUNTERS_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "WJ_DRAGONBONE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_DRAGONBONE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "WJ_HIGHLIGHT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_HIGHLIGHT_SYSTEM", 0);
#endif

#ifdef WJ_OFFLINESHOP_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_OFFLINESHOP_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_OFFLINESHOP_SYSTEM", 0);
#endif

#ifdef WJ_MULTIPRICE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_MULTIPRICE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_MULTIPRICE_SYSTEM", 0);
#endif

#ifdef WJ_SHOPSTYLE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_SHOPSTYLE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SHOPSTYLE_SYSTEM", 0);
#endif

#ifdef WJ_SHOPSOLD_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_SHOPSOLD_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SHOPSOLD_SYSTEM", 0);
#endif

#ifdef WJ_WOLFMAN_CHARACTER
	PyModule_AddIntConstant(poModule, "WJ_WOLFMAN_CHARACTER", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_WOLFMAN_CHARACTER", 0);
#endif

#ifdef WJ_CHEQUE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_CHEQUE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_CHEQUE_SYSTEM", 0);
#endif

#ifdef WJ_NEW_EXCHANGE_WINDOW
	PyModule_AddIntConstant(poModule, "WJ_NEW_EXCHANGE_WINDOW", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_NEW_EXCHANGE_WINDOW", 0);
#endif

#ifdef WJ_EXTENDED_SHOP_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_EXTENDED_SHOP_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_EXTENDED_SHOP_SYSTEM", 0);
#endif

#ifdef WJ_QUEST_RECEIVE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_QUEST_RECEIVE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_QUEST_RECEIVE_SYSTEM", 0);
#endif

#ifdef WJ_CHANNEL_CHANGE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_CHANNEL_CHANGE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_CHANNEL_CHANGE_SYSTEM", 0);
#endif

#ifdef WJ_PLAYER_TITLE_NAME_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_PLAYER_TITLE_NAME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_PLAYER_TITLE_NAME_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "WJ_GROWTH_PET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_GROWTH_PET_SYSTEM", 0);
#endif

#ifdef WJ_NATIONAL_POINT_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_NATIONAL_POINT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_NATIONAL_POINT_SYSTEM", 0);
#endif

#ifdef WJ_CHANGELOOK_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_CHANGELOOK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_CHANGELOOK_SYSTEM", 0);
#endif

#ifdef WJ_MAGIC_REDUCION_BONUS
	PyModule_AddIntConstant(poModule, "WJ_MAGIC_REDUCION_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_MAGIC_REDUCION_BONUS", 0);
#endif

#ifdef WJ_ITEM_COMBINATION_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_ITEM_COMBINATION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_ITEM_COMBINATION_SYSTEM", 0);
#endif

#ifdef WJ_WEAPON_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_WEAPON_COSTUME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_WEAPON_COSTUME_SYSTEM", 0);
#endif

#ifdef WJ_SKILLBOOK_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_SKILLBOOK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SKILLBOOK_SYSTEM", 0);
#endif

#ifdef WJ_TIME_LIMIT_WEAPON_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_TIME_LIMIT_WEAPON_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_TIME_LIMIT_WEAPON_SYSTEM", 0);
#endif

#ifdef WJ_QUIVER_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_QUIVER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_QUIVER_SYSTEM", 0);
#endif

#ifdef WJ_ENCHANT_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_ENCHANT_COSTUME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_ENCHANT_COSTUME_SYSTEM", 0);
#endif

#ifdef WJ_UPGRADE_SOCKET_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_UPGRADE_SOCKET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_UPGRADE_SOCKET_SYSTEM", 0);
#endif

#ifdef WJ_ONLINE_PLAYER_COUNT
	PyModule_AddIntConstant(poModule, "WJ_ONLINE_PLAYER_COUNT", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_ONLINE_PLAYER_COUNT", 0);
#endif

#ifdef WJ_EXTENDED_PET_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_EXTENDED_PET_SYSTEM", 1);
#else
	PyModule_AddIntConstnat(poModule, "WJ_EXTENDED_PET_SYSTEM", 0);
#endif
...
#ifdef WJ_162_ARMOR_EFFECT
	PyModule_AddIntConstant(poModule, "WJ_162_ARMOR_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_162_ARMOR_EFFECT", 0);
#endif

#ifdef WJ_MELEY_LAIR_DUNGEON
	PyModule_AddIntConstant(poModule, "WJ_MELEY_LAIR_DUNGEON", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_MELEY_LAIR_DUNGEON", 0);
#endif

#ifdef WJ_TEMPLE_OCHAO
	PyModule_AddIntConstant(poModule, "WJ_TEMPLE_OCHAO", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_TEMPLE_OCHAO", 0);
#endif

#ifdef WJ_OKEY_CARD_EVENT
	PyModule_AddIntConstant(poModule, "WJ_OKEY_CARD_EVENT", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_OKEY_CARD_EVENT", 0);
#endif

#ifdef WJ_SELLING_DRAGONSOUL
	PyModule_AddIntConstant(poModule, "WJ_SELLING_DRAGONSOUL", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SELLING_DRAGONSOUL", 0);
#endif

#ifdef WJ_CHANGE_ATTRIBUTE_PLUS
	PyModule_AddIntConstant(poModule, "WJ_CHANGE_ATTRIBUTE_PLUS", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_CHANGE_ATTRIBUTE_PLUS", 0);
#endif

#ifdef WJ_CHANGE_ATTRIBUTE_MINUS
	PyModule_AddIntConstant(poModule, "WJ_CHANGE_ATTRIBUTE_MINUS", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_CHANGE_ATTRIBUTE_MINUS", 0);
#endif

#ifdef WJ_SHOP_SEARCH_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_SHOP_SEARCH_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SHOP_SEARCH_SYSTEM", 0);
#endif

#ifdef WJ_GEM_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_GEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_GEM_SYSTEM", 0);
#endif
