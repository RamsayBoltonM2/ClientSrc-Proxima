...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_NATIONAL_POINT",	CInstanceBase::EFFECT_NATIONAL_POINT);
#endif
	
	PyModule_AddIntConstant(poModule, "EFFECT_DEADLY_POWER_RING", CInstanceBase::EFFECT_DEADLY_POWER_RING);
	PyModule_AddIntConstant(poModule, "EFFECT_WILL_POWER_RING",  CInstanceBase::EFFECT_WILL_POWER_RING);
	PyModule_AddIntConstant(poModule, "EFFECT_MEDAL_OF_HEROISM", CInstanceBase::EFFECT_MEDAL_OF_HEROISM);
	PyModule_AddIntConstant(poModule, "EFFECT_MAGIC_CANDY", CInstanceBase::EFFECT_MAGIC_CANDY);
	PyModule_AddIntConstant(poModule, "EFEFCT_CHOCOLATE_CHARM", CInstanceBase::EFEFCT_CHOCOLATE_CHARM);
	PyModule_AddIntConstant(poModule, "EFFECT_EVIL_EYE_CHARM", CInstanceBase::EFFECT_EVIL_EYE_CHARM);
