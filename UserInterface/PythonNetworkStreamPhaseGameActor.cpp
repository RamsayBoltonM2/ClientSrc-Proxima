...
void __SetWeaponPower(IAbstractPlayer& rkPlayer, DWORD dwWeaponID)
{
	...
	CItemData* pkWeapon;
#if defined(WJ_WEAPON_COSTUME_SYSTEM) || defined(WJ_CHANGELOOK_SYSTEM)
...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_lWeaponRarity=0;
#endif
...
#ifdef WJ_GUILD_LEADER_SYSTEM
		kNetActorData.m_dwGuildAuth=chrInfoPacket.dwGuildAuth;
#endif
#ifdef WJ_EVOLUTION_SYSTEM
		kNetActorData.m_lWeaponRarity=chrInfoPacket.lWeaponRarity;
#endif
		__RecvCharacterAppendPacket(&kNetActorData);
	}
	else
...
#ifdef WJ_GUILD_LEADER_SYSTEM
	kNetActorData.m_dwGuildAuth=chrAddPacket.dwGuildAuth;
#endif
#ifdef WJ_EVOLUTION_SYSTEM
	kNetActorData.m_lWeaponRarity=chrAddPacket.lWeaponRarity;
#endif
	kNetActorData.m_fRot=chrAddPacket.angle;
	kNetActorData.m_kAffectFlags.CopyData(0, sizeof(chrAddPacket.dwAffectFlag[0]), &chrAddPacket.dwAffectFlag[0]);
	kNetActorData.m_kAffectFlags.CopyData(32, sizeof(chrAddPacket.dwAffectFlag[1]), &chrAddPacket.dwAffectFlag[1]);
...
bool CPythonNetworkStream::RecvCharacterUpdatePacket()
{
	...
	kNetUpdateActorData.m_dwLevel=chrUpdatePacket.dwLevel;	// level update fix
...
#ifdef WJ_GUILD_LEADER_SYSTEM
	kNetUpdateActorData.m_dwGuildAuth=chrUpdatePacket.dwGuildAuth;
#endif
#ifdef WJ_EVOLUTION_SYSTEM
	kNetUpdateActorData.m_lWeaponRarity=chrUpdatePacket.lWeaponRarity;
#endif
