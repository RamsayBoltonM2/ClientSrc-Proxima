...
{
	if (GetRace() == 30000 || GetRace() == 30002 || GetRace() == 30003 || GetRace() == 30004)
	{
		return NAMECOLOR_PC;
	}
...
void CInstanceBase::AttachTextTail()
{
	...
	CPythonTextTail::Instance().RegisterCharacterTextTail(m_dwGuildID, m_dwGuildAuth, dwVID, s_kD3DXClrTextTail, fTextTailHeight);
#else
...
void CInstanceBase::UpdateTextTailLevel(DWORD level)
{
	...
	if (IsPC() || GetRace() == 30000 || GetRace() == 30002 || GetRace() == 30003 || GetRace() == 30004)
#else
	if (IsPC())
#endif
