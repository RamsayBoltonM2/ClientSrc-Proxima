...
bool PackInitialize(const char * c_pszFolder)
{
	...
	CEterPackManager::Instance().RegisterPack("pack/locale_sg", "locale");
	...
	CEterPackManager::Instance().RegisterPack("pack/pc3_common", "d:/ymir work/pc3");
	CEterPackManager::Instance().RegisterPack("pack/pc3_wolfman", "d:/ymir work/pc3");
	...
	CEterPackManager::Instance().RegisterPack("pack/patch1", "d:/ymir work");
	CEterPackManager::Instance().RegisterPack("pack/patch2", "d:/ymir work");
