...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_EXCHANGE_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCExchageInfo), STATIC_SIZE_PACKET));
#endif
		}
};
...
//			return rkSimplePlayerInfo.wParts[CRaceData::PART_MAIN];
		...
		case ACCOUNT_CHARACTER_SLOT_NATIONAL_POINT:
			return rkSimplePlayerInfo.lNationalPoint;
			break;
#endif
