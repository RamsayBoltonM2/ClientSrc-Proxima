...
PyObject * itemIsUpgradeSocketScroll(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (iItemIndex == 80018)
		return Py_BuildValue("i", 1);
	else if (iItemIndex == 80019)
		return Py_BuildValue("i", 2);
	else if (iItemIndex == 80020)
...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "USE_MOUNT", CItemData::USE_MOUNT);
#endif
	...
	PyModule_AddIntConstant(poModule, "USE_CHANGE_ATTRIBUTE4", CItemData::USE_CHANGE_ATTRIBUTE4);
#endif
