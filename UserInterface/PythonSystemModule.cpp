...
PyObject * systemSetShowMoneyTextFlag(PyObject * poSelf, PyObject * poArgs) // gold
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();
...
PyObject * systemSetShowOnlineInfoTextFlag(PyObject * poSelf, PyObject * poArgs) // online
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowOnlineInfoTextFlag(iFlag);

	return Py_BuildNone();
}

PyObject * systemSetShowDateInfoTextFlag(PyObject * poSelf, PyObject * poArgs) // date
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowDateInfoTextFlag(iFlag);

	return Py_BuildNone();
}

PyObject * systemSetShowShopsFlag(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();
	
	CPythonSystem::Instance().SetShowShopsFlag(iFlag);
	
	return Py_BuildNone();
}

PyObject * systemSetShowHighlight(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();
	
	CPythonSystem::Instance().SetShowHighlightFlag(iFlag);
...
PyObject * systemIsShowMoneyText(PyObject * poSelf, PyObject * poArgs) // gold
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowMoneyText());
}

PyObject * systemIsShowOnlineInfoText(PyObject * poSelf, PyObject * poArgs) // online
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowOnlineInfoText());
}

PyObject * systemIsShowDateInfoText(PyObject * poSelf, PyObject * poArgs) // date
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowDateInfoText());
}

PyObject * systemIsShowShops(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowShops());
}

PyObject * systemIsShowHighlight(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowHighlight());
}
...
PyObject * systemIsExpInfoText(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsExpInfoText());
}

PyObject * systemSetExpInfoTextFlag(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();
	
	CPythonSystem::Instance().SetExpInfoTextFlag(iFlag);
...
void initsystem()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetShowMoneyTextFlag",		systemSetShowMoneyTextFlag,			METH_VARARGS}, // gold
		{ "IsShowMoneyText",			systemIsShowMoneyText,				METH_VARARGS}, // gold
		
		{ "SetShowOnlineInfoTextFlag",	systemSetShowOnlineInfoTextFlag,	METH_VARARGS}, // online
		{ "IsShowOnlineInfoText",		systemIsShowOnlineInfoText,			METH_VARARGS}, // online
		
		{ "SetShowDateInfoTextFlag",	systemSetShowDateInfoTextFlag,		METH_VARARGS}, // date
		{ "IsShowDateInfoText",			systemIsShowDateInfoText,			METH_VARARGS}, // date
		...
		{ "IsShowShops",				systemIsShowShops,				METH_VARARGS },
		{ "SetShowShopFlag",			systemSetShowShopsFlag,			METH_VARARGS },
		
		{ "IsShowHighlight",			systemIsShowHighlight,			METH_VARARGS },
		{ "SetShowHighlightFlag",			systemSetShowHighlight,			METH_VARARGS },
		
		{ "IsShowLevel",				systemIsShowLevel,				METH_VARARGS },
		{ "SetShowLevelFlag",			systemSetShowLevel,				METH_VARARGS },
			
		{ "IsExpInfoText",				systemIsExpInfoText,			METH_VARARGS },
		{ "SetExpInfoTextFlag",			systemSetExpInfoTextFlag,		METH_VARARGS },
