...
void CPythonSystem::SetDefaultConfig()
{
	...
	m_Config.bShowOnlineInfoText	= true;
	m_Config.bShowDateInfoText		= true;
	m_Config.bShowShops				= true;
	m_Config.bShowHighlight			= true;
	m_Config.bShowLevel				= true;
	m_Config.bExpInfoText			= true;
}
...
bool CPythonSystem::IsShowOnlineInfoText()
{
	return m_Config.bShowOnlineInfoText;
}

void CPythonSystem::SetShowOnlineInfoTextFlag(int iFlag)
{
	m_Config.bShowOnlineInfoText = iFlag == 1 ? true : false;
}

bool CPythonSystem::IsShowDateInfoText()
{
	return m_Config.bShowDateInfoText;
}

bool CPythonSystem::IsShowShops()
{
	return m_Config.bShowShops;
}

bool CPythonSystem::IsShowHighlight()
{
	return m_Config.bShowHighlight;
}
...
bool CPythonSystem::IsExpInfoText()
{
	return m_Config.bExpInfoText;
}

void CPythonSystem::SetShowDateInfoTextFlag(int iFlag)
{
	m_Config.bShowDateInfoText = iFlag == 1 ? true : false;
}

void CPythonSystem::SetShowShopsFlag(int iFlag)
{
	m_Config.bShowShops = iFlag == 1 ? true : false;
	CPythonCharacterManager & rkChrMgr = CPythonCharacterManager::Instance();
#ifdef WJ_OFFLINESHOP_SYSTEM
	rkChrMgr.SetVisibleForOfflineShops(iFlag == 1 ? true : false);
#endif
}

void CPythonSystem::SetShowHighlightFlag(int iFlag)
{
	m_Config.bShowHighlight = iFlag == 1 ? true : false;
}
...
void CPythonSystem::SetExpInfoTextFlag(int iFlag)
{
	m_Config.bExpInfoText = iFlag == 1 ? true : false;
}
...
bool CPythonSystem::LoadConfig()
{
	...
	while (fgets(buf, 256, fp))
	{
		...
		else if (!stricmp(command, "SHOW_ONLINE_INFO_TEXT"))
			m_Config.bShowOnlineInfoText = atoi(value) == 1 ? true : false;
		else if (!stricmp(command, "SHOW_DATE_INFO_TEXT"))
			m_Config.bShowDateInfoText = atoi(value) == 1 ? true : false;
		else if (!stricmp(command, "SHOW_SHOPS"))
			m_Config.bShowShops = atoi(value) == 1 ? true : false;
		else if (!stricmp(command, "SHOW_HIGHLIGHT"))
			m_Config.bShowHighlight = atoi(value) == 1 ? true : false;
		else if (!stricmp(command, "SHOW_LEVEL"))
			m_Config.bShowLevel = atoi(value) == 1 ? true : false;
		else if (!stricmp(command, "EXP_INFOTEXT"))
			m_Config.bExpInfoText = atoi(value) == 1 ? true : false;
	}
...
bool CPythonSystem::SaveConfig()
{
	...
	if (m_Config.bShowOnlineInfoText == 0)
		fprintf(fp, "SHOW_ONLINE_INFO_TEXT	%d\n", m_Config.bShowOnlineInfoText);
	if (m_Config.bShowDateInfoText == 0)
		fprintf(fp, "SHOW_DATE_INFO_TEXT	%d\n", m_Config.bShowDateInfoText);
	...
	fprintf(fp, "SHOW_SHOPS			%d\n", m_Config.bShowShops);
	fprintf(fp, "SHOW_HIGHLIGHT		%d\n", m_Config.bShowHighlight);
	fprintf(fp, "SHOW_LEVEL			%d\n", m_Config.bShowLevel);
	fprintf(fp, "EXP_INFOTEXT	%d\n", m_Config.bExpInfoText);
	fprintf(fp, "\n");
