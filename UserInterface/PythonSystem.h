...
class CPythonSystem : public CSingleton<CPythonSystem>
{
	public:
		...
		typedef struct SConfig
		{
			...
			bool			bShowMobAIFlag;
#endif
			bool			bShowMoneyText;	// gold
			bool			bShowOnlineInfoText;	// online
			bool			bShowDateInfoText;	// date
			bool			bShowShops;
			bool			bShowHighlight;
			bool			bShowLevel;
			bool			bExpInfoText;
	...
	public:
		...
		bool							IsShowOnlineInfoText();
		bool							IsShowDateInfoText();
		bool							IsShowShops();
		...
		void							SetShowOnlineInfoTextFlag(int iFlag);
		void							SetShowDateInfoTextFlag(int iFlag);
		void							SetShowShopsFlag(int iFlag);
		void							SetShowHighlightFlag(int iFlag);
		void							SetShowLevelFlag(int iFlag);
		void							SetExpInfoTextFlag(int iFlag);
