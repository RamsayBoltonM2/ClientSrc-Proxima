...
{	
	...
	public:
		...
		enum
		{
			...
			AFFECT_DRAGON_BONE_1,
			AFFECT_DRAGON_BONE_2,
#endif
...
#ifdef WJ_DRAGONBONE_SYSTEM
			NEW_AFFECT_DRAGONBONE_1 = 304,
			NEW_AFFECT_DRAGONBONE_2 = 305,
#endif
...
#if defined(WJ_WOLFMAN_CHARACTER) && defined(WJ_EVOLUTION_SYSTEM)
			EFFECT_CLAW_RARITY0,
			EFFECT_CLAW_RARITY1,
			EFFECT_CLAW_RARITY2,
			EFFECT_CLAW_RARITY3,
		...
		enum
		{
			...
			EFFECT_NATIONAL_POINT,
#endif
			EFFECT_DEADLY_POWER_RING,
			EFFECT_WILL_POWER_RING,
			EFFECT_MEDAL_OF_HEROISM,
			EFFECT_MAGIC_CANDY,
			EFEFCT_CHOCOLATE_CHARM,
			EFFECT_EVIL_EYE_CHARM,
	...
	public:
		...
		void					SetLevel(DWORD level);	// level update fix
		...
		bool					SetWeapon(DWORD eWeapon, long lWeaponRarity = 0, DWORD eArrow = 0);
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
		bool					SetWeapon(DWORD eWeapon, long lWeaponRarity = 0);
#elif !defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
...
#endif
#ifdef WJ_EVOLUTION_SYSTEM
		void					SetWeaponRarity(long lWeaponRarity) { m_lWeaponRarity = lWeaponRarity; }
#endif
		bool					ChangeArmor(DWORD dwArmor);
#if defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
		void					ChangeWeapon(DWORD eWeapon, long lWeaponRarity = 0, DWORD eArrow = 0);
#elif defined(WJ_EVOLUTION_SYSTEM) and !defined(WJ_QUIVER_SYSTEM)
		void					ChangeWeapon(DWORD eWeapon, long lWeaponRarity = 0);
#elif !defined(WJ_EVOLUTION_SYSTEM) and defined(WJ_QUIVER_SYSTEM)
...
#ifdef WJ_GUILD_LEADER_SYSTEM
		void					ChangeGuild(DWORD dwGuildID, DWORD dwGuildAuth);
#else
...
#ifdef WJ_EVOLUTION_SYSTEM
		UINT	__GetRefinedEffect(CItemData* pItem, long lWeaponRarity);
#else
