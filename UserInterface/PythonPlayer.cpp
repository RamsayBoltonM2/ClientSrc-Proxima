...
#ifdef WJ_ACCE_SYSTEM
void CPythonPlayer::SetAcceItemData(DWORD dwSlotIndex, const TItemData & rItemInstance)
{
...
BOOL CPythonPlayer::GetAcceItemDataPtr(DWORD dwSlotIndex, TItemData ** ppInstance)
{
	if (dwSlotIndex >= m_ItemAcceInstanceVector.size())
	{
